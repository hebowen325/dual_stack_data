...
func main() {
        ...
        files, err := ioutil.ReadDir("/home/sgl/bwhe/Router/data/data_ipv4/")
        if err != nil {
                panic(err)
        }
        // 获取文件，并输出它们的名字
        for _, file := range files {
                if file.Name()[0:4]=="file" {
                        data, err := ioutil.ReadFile("/home/sgl/bwhe/Router/data/data_ipv4/" + file.Name())
                        if err != nil {
